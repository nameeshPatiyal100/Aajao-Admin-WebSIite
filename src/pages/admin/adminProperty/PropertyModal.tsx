...
const states = ["California", "Texas", "Florida", "New York", "Nevada", "Washington"];
const categories = ["Apartment", "Villa", "Studio", "Penthouse", "Townhouse", "Condo"];
const tags = ["Beachfront", "Mountain View", "City Center", "Luxury", "Modern", "Historic"];
...
const PropertyModal: React.FC<PropertyModalProps> = ({ open, onClose, onSubmit }) => {
  ...
  return (
    <StyledDialog open={open} onClose={onClose} maxWidth={false}>
      ...
      <DialogContent sx={{ padding: '20px', maxHeight: '70vh', overflowY: 'auto' }}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={4}>
              <FormControl fullWidth>
                <InputLabel sx={{ color: '#6b7280', '&.Mui-focused': { color: '#7c3aed' } }}>
                  Categories
                </InputLabel>
                <Select
                  multiple
                  ...
                  input={<OutlinedInput label="Categories" sx={{ borderRadius: '12px' }} />}
                  MenuProps={MenuProps}
            ...
            <Grid item xs={12} md={4}>
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  input={<OutlinedInput label="Amenities" sx={{ borderRadius: '12px' }} />}
                  MenuProps={MenuProps}
                  renderValue={(selected) => (
                    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
                      {(selected as string[]).map((value) => (
        ...
        <FormSection elevation={0}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={6}>
              ...
              <ImageUploadBox>
                <PhotoCamera />
                <Typography variant="h6" sx={{ mb: 1, color: '#7c3aed', fontWeight: 600 }}>
                  Upload Cover Image
                </Typography>
      ...
      <DialogActions sx={{ padding: '20px', background: 'rgba(139, 69, 193, 0.02)' }}>
        <Button
          onClick={onClose}
          variant="outlined"
          sx={{
